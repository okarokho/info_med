...
class _ReminderState extends State<Reminder> {
  @override
  void initState() {
    context.read<DataProvider>().getDateReminder(DateTime.now());
    super.initState();
  }
            ...
            Container(
              ...
              child: DatePicker(
                ...
                onDateChange: (selectedDate) => setState(() {
                  ...
                  context.read<DataProvider>().getDateReminder(selectedDate);
                }),
            ...
            Expanded(
              child: Consumer<DataProvider>(
                  builder: (context, data, child) => data
                              ...
                              child: ClipRRect(
                                ...
                                child: Container(
                                  ...
                                  child: GestureDetector(
                                    onDoubleTap: () {
                                      DatabaseHelper.instance.deleteReminder(
                                          data.listReminder[index].name
                                              .toString(),
                                          data.listReminder[index].date
                                              .toString());
                                      context
                                          .read<DataProvider>()
                                    ...
                                    child: ListTile(
                                      leading: Image.asset(data
                                          .listReminder[index].image
                                          .toString()),
                                      title: Text(data.listReminder[index].name
                                          .toString()),
                                      subtitle: Row(
                                        mainAxisAlignment:
                                            MainAxisAlignment.start,
                                        children: [
                                          Text(data.listReminder[index].dose
                                              .toString()),
                                          const SizedBox(
                                            width: 5,
                                          ),
                                          Text(data.listReminder[index].type
                                              .toString()),
                                        ],
                                      ),
                                      trailing: Column(
                                        ...
                                        children: [
                                          ...
                                          Text(DateFormat(
                                                  ...
                                                  AppLocalizations.of(context)!
                                                      .local)
                                              .format(data.listReminder[index]
                                                  .timeFuture!))
                                        ],
                                      ),
                                    ),
                      ...
                      : Center(
                          child: TitleText(
                              txt: AppLocalizations.of(context)!.noDrug,
                              size: 20))),
            )
          ],
        )),
