...
String capitalize(String s) => s[0].toUpperCase() + s.substring(1);
  ...
  Widget build(BuildContext context) {
              return CustomScrollView(
                ...
                slivers: [
                  ...
                  child: Wrap(
                    children: [
                      chip(1,6,'All',widget.drugs),
                      chip(2,6,'Anti-inflammatory',widget.antinflammatory),
                      chip(3,6,'Antibiotec',widget.antibiotec),
                      chip(4,6,'Heart',widget.heart),
                      chip(5,8,'Stimulants',widget.stimulants),
                      chip(6,6,'Lungs',widget.lungs),
                      chip(7,6,'Sleep Disorder',widget.sleepDisorder),
                      chip(8,6,'Eye',widget.eye),
                      chip(9,8,'Hormons',widget.hormons),
                      chip(10,6,'Anti-depressant',widget.antidepressants),
                      chip(11,6,'Seizure',widget.seizure),
                      chip(12,8,'Pain Killer',widget.painKiller),
                      chip(13,6,'Diabetes',widget.diabetes),
                      chip(14,6,'Stomach',widget.stomach),
                      chip(15,6,'Others',widget.others),
                    const SizedBox(
                          width: 15,
                        )
                    ],
  ...
  Padding chip(int index,double padding,String text,List<String> x) {
    return Padding(
