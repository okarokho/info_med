...
class CategoryChip extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
              padding: AppLocalizations.of(context)!.language=='English'?EdgeInsets.only(left: padding):EdgeInsets.only(right: padding),
              ...
              onSelected: (value) => Provider.of<DataProvider>(context,listen: false).updateChip(currentIndex, temp),
      )
    );
  }
}