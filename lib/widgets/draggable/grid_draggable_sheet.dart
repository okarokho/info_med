...
import '../../util/image compression/image.dart';
          ...
          child: Container(
              ...
              child: Consumer2<DatabaseHelper, SharedPreference>(
                builder: (context, db, value, child) {
                  ...
                  final boxInstance = Boxes.getBox().values.where((element) =>
                      element.name == widget.name &&
                      element.language == AppLocalizations.of(context)!.local);
                  // get side effect list
                  final sideffect = boxInstance.first.sideEffect
                      .toString()
                      .substring(1, boxInstance.first.sideEffect.length - 1)
                      .split(RegExp("[,;،]"));
                        ...
                        child: Padding(
                          ...
                          child: ListView(
                            ...
                            children: [
                              ...
                              TitleText(
                                txt: boxInstance.first.description,
                                size: 14,
                              ),
                              const SizedBox(
                                height: 10,
                              ...
                              TitleText(
                                txt: boxInstance.first.instruction,
                                size: 14,
                              ),
                              const SizedBox(
                                height: 10,
